  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="w-full rounded-2xl border-2 border-dashed border-gray-300 p-6 text-gray-500 transition-colors hover:border-emerald-400 hover:text-emerald-600"
      >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            disabled={isPending}
            className="flex items-center gap-1 rounded-xl bg-gray-100 px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-200 disabled:opacity-50"
          >
            <X className="h-4 w-4" />
            取消
          </button>
